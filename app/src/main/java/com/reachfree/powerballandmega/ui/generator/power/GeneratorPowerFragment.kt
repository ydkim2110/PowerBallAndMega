package com.reachfree.powerballandmega.ui.generator.power
...
import com.reachfree.powerballandmega.ui.generator.*
...
@AndroidEntryPoint
class GeneratorPowerFragment : BaseFragment<GeneratorPowerFragmentBinding>(), NumberSelectListener {
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ): GeneratorPowerFragmentBinding {
        return GeneratorPowerFragmentBinding.inflate(inflater, container,false)
    }
    ...
    private fun setupRecyclerView() {
        binding.rvNumber.apply {
            ...
            generatorAdapter = GeneratorAdapter(numberModels, this@GeneratorPowerFragment)
        ...
        binding.rvNumberPowerPlay.apply {
            setHasFixedSize(true)
            layoutManager = GridLayoutManager(activity, GRID_SPAN_COUNT)
            generatorPowerPlayAdapter = GeneratorAdapter(numberPowerPlayModels, this@GeneratorPowerFragment)
    ...
    private fun generatePowerBallNumber() {
        generatedNumberList?.clear()
    ...
    companion object {
        ...
        fun newInstance() = GeneratorPowerFragment()
    }
