package com.reachfree.powerballandmega.ui.savednumber.mega
...
import com.reachfree.powerballandmega.databinding.SavedNumberMegaFragmentBinding
...
@AndroidEntryPoint
class SavedNumberMegaFragment : Fragment(), SavedNumberAdapter.OnItemClickListener {

    private var _binding: SavedNumberMegaFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = SavedNumberMegaFragmentBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        localViewModel.getLottoByType(Constants.TYPE_MEGA)
    }

    private fun showProgressBar() {
        binding.rvPowerResult.visibility = View.GONE
        binding.progressSavedMega.visibility = View.VISIBLE
    }

    private fun hideProgressBar() {
        binding.rvPowerResult.visibility = View.VISIBLE
        binding.progressSavedMega.visibility = View.GONE
    }
            ...
            localViewModel.lottoResponse.collect { event ->
                when (event) {
                    ...
                    is LocalViewModel.LocalDatabaseEvent.Success -> {
                        savedNumberAdapter = SavedNumberAdapter(gameCategoryList, event.resultList, this@SavedNumberMegaFragment)
    ...
    companion object {
        fun newInstance() = SavedNumberMegaFragment()
    }
